...
public class FeedDAO extends PagedDatabase<Status, Status> {
    ...
    public void add(Status toAdd) {
        ...
        newStatus.setReceiver_alias(toAdd.getUser().getAlias());
        //loop through the followers and give new status
//        List<User> toReturn = DynamoDAOFactory.getInstance().getFollowDAO().get()
